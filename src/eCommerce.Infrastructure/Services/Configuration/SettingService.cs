...
public class SettingService : ISettingService
{
    ...
    public void ClearCache() => _staticCacheManager.RemoveByPrefix(EntityCacheDefaults<Setting>.Prefix);

    public async Task ClearCacheAsync() => await _staticCacheManager.RemoveByPrefixAsync(EntityCacheDefaults<Setting>.Prefix);
    ...
    public void SetSetting<T>(string key, T value, bool clearCache = true) => SetSetting(typeof(T), key, value, clearCache);

    public async Task SetSettingAsync<T>(string key, T value, bool clearCache = true) => await SetSettingAsync(typeof(T), key, value, clearCache);
    ...
    public IList<Setting> GetAllSettings() => _settingRepository.GetAll(getCacheKey: q => q.PrepareKeyForDefaultCache(EntityCacheDefaults<Setting>.AllCacheKey));

    public async Task<IList<Setting>> GetAllSettingsAsync() => await _settingRepository.GetAllAsync(getCacheKey: q => q.PrepareKeyForDefaultCache(EntityCacheDefaults<Setting>.AllCacheKey));

    public Setting? GetSettingById(Guid settingId) => _settingRepository.GetById(settingId, q => q.PrepareKey(EntityCacheDefaults<Setting>.ByIdCacheKey, settingId));

    public async Task<Setting?> GetSettingByIdAsync(Guid settingId) => await _settingRepository.GetByIdAsync(settingId, q => q.PrepareKey(EntityCacheDefaults<Setting>.ByIdCacheKey, settingId));
