...
public class QueuedEmailBuilder : IEntityBuilder
{
    ...
    public void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(QueuedEmail.Body)).AsString(int.MaxValue).NotNullable()
            ...
            .WithColumn(nameof(QueuedEmail.AttachmentFilePath)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(QueuedEmail.AttachmentFileName)).AsString(int.MaxValue).Nullable()
