...
public class CustomerSecurityBuilder : IEntityBuilder
{
    ...
    public void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(CustomerSecurity.LastIpAddress)).AsString(64).Nullable()
            ...
            .WithColumn(nameof(CustomerSecurity.CannotLoginUntilDateUtc)).AsCustomDateTime().Nullable();
    }
