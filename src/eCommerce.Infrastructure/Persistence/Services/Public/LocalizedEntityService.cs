...
public class LocalizedEntityService : ILocalizedEntityService
{
        ...
        string localeKey)
    {
        var key = _staticCacheManager.PrepareKeyForDefaultCache(
            YerdenYuksekLocalizationDefaults.LocalizedPropertiesCacheKey,
            entityId,
            localeKeyGroup,
            localeKey);
    ...
    {
        var key = _staticCacheManager.PrepareKeyForDefaultCache(
            YerdenYuksekLocalizationDefaults.LocalizedPropertyCacheKey,
            languageId,
            entityId,
            localeKeyGroup,
            localeKey);
        ...
        return await _staticCacheManager.GetAsync(key, async () =>
        {
            if (_localizationSettings.LoadAllLocalizedPropertiesOnStartup)
            {
                var lookupKey = _staticCacheManager.PrepareKeyForDefaultCache(
                    YerdenYuksekLocalizationDefaults.LocalizedPropertyLookupCacheKey,
                    languageId);
